...
<head>
    ...
    <meta name="msapplication-TileImage" content="{{ asset('assets/images/logo.jpg')}}">
                            ...
                            <div class="menu-left">
                                <div class="brand-logo">
                                    <a href="{{route('app.index')}}">
                                        <img src="{{asset('assets/images/logo.jpg')}}" class="h-logo img-fluid blur-up lazyload"
                                            alt="logo">
                                    </a>
                                </div>
                                ...
                                <div class="main-navbar">
                                    <div id="mainnav">
                                        ...
                                        <ul class="nav-menu">
                                            ...
                                            <li><a href="{{route('shop.index')}}" class="nav-link menu-title">Kola</a></li>
                                    ...
                                    <li class="onhover-dropdown">
                                        ...
                                        <div class="onhover-div profile-dropdown">
                                            <ul>
                                                ...
                                                @else 
                                                <li>
                                                        <a href="{{route('login')}}" class="d-block">Přihlášení</a>
                                                    </li>
                                                    <li>
                                                        <a href="{{route('register')}}" class="d-block">Registrace</a>
                                                    </li>   
                                                @endauth
                                                @endif
                        ...
                        <div class="footer-contact">
                            <div class="brand-logo">
                                <a href="{{route('app.index')}}" class="footer-logo float-start">
                                    <img src="{{asset('assets/images/logo.jpg')}}" class="f-logo img-fluid blur-up lazyload"
                                        alt="logo">
                                </a>
                            </div>
                            <ul class="contact-lists" style="clear:both;">
                                <li>
                                    <span><b>Telefonní číslo:</b> <span class="font-light">+420 324 953 649</span></span>
                                </li>
                                <li>
                                    <span><b>Adresa:</b><span class="font-light"> Czech Republic, Dlouhá 342, Mladá Boleslav, PSČ: 293 01</span></span>
                                </li>
                                <li>
                                    <span><b>Email:</b><span class="font-light"> dobrakola@seznam.cz</span></span>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="sub-footer">
            <div class="container">
                <div class="row gy-3">
                    ...
                    <div class="col-md-6">
                        <p class="mb-0 font-dark">© 2023, Tomáš Maroul - Informační managment</p>
                    </div>
                </div>
            </div>
        </div>
